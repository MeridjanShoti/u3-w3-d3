...
const temistualdo: User = {
  name: "temistualdo",
  email: "temistualdo@vdm.it",
};

console.log(`type of ${temistualdo.name}`, typeof temistualdo.name);
console.log(`type of ${temistualdo.email}`, typeof temistualdo.email);
...
const studente1: Studente = { nome: "Mario", voto: 7 };
const studente2: Studente = { nome: "Luigi", voto: 5 };
const studente3: Studente = { nome: "Giangianni", voto: 10 };

let studentArray: Studente[];
...
interface Veicolo {
  ruote: number;
  alimentazione: "benzina" | "elettrico" | "ibrido" | "diesel" | "gas" | "nessuna" | "altro";
  vola?: boolean;
}
